...
if uploaded_file is not None:
    ...
    if save_uploaded_file(uploaded_file): 
        ...
        st.title("customer response: "+ customer_res)
         
        pricing_res = predict_pricing(featuesAll)
        st.title("pricing explained: "+ pricing_res)
        
        exclusions_res = predict_exclusion(featuesAll)
        st.title("exclusions explained: "+ exclusions_res)
        
        claim_res = predict_claim(featuesAll)
        st.title("claim process explained: "+ claim_res)
