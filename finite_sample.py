...
exclusions_6_res_model = load_model('./ex_61.h5')
exclusions_7_res_model = load_model('./ex_71.h5')
exclusions_8_res_model = load_model('./ex_81.h5')
